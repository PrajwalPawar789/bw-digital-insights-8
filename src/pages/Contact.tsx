...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Added immersive background */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1493397212122-2b85dda8106b?auto=format&fit=crop&w=1920&q=80')] bg-cover bg-fixed opacity-10"></div>
