...
export const teamData: TeamMember[] = [
  {
    ...
    bio: "Maria brings over 20 years of leadership experience in business intelligence and market research. Under her vision, The CIO Vision has grown to become a leading source of business insights across global markets.",
  ...
  },
  {
    ...
    bio: "Thomas oversees The CIO Vision's comprehensive research methodologies and ensures the highest standards of analytical rigor across all publications and advisory services.",
  ...
  },
  {
    ...
    bio: "Jennifer leads the development of The CIO Vision's editorial strategy across digital and print platforms, ensuring our content delivers actionable value to business leaders worldwide.",
  ...
  },
  {
    ...
    bio: "Michael drives The CIO Vision's digital transformation, implementing advanced analytics platforms that power our research insights and client delivery systems.",
  ...
  },
  {
    ...
    bio: "Sarah directs The CIO Vision's research and advisory services related to environmental, social, and governance (ESG) strategies across global markets and industries.",
  ...
  },
  {
    ...
    bio: "David leads The CIO Vision's technology industry practice, analyzing emerging trends and their business implications for technology providers and enterprise technology leaders.",
  ...
  },
  {
    ...
    bio: "James oversees The CIO Vision's executive development programs, bringing extensive experience in leadership coaching and organizational transformation.",
  ...
  },
  {
    ...
    bio: "Robert leads The CIO Vision's international expansion, developing market-specific research capabilities and client relationships across Asia, Europe, and emerging markets.",
    image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8cHJvZmVzc2lvbmFsJTIwbWFufGVufDB8fDB8fHww"
  }
];
