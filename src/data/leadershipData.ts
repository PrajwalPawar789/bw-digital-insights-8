...
export const leadershipData: Leader[] = [
  {
    ...
    company: "The CIO Vision",
    bio: "Maria Rodriguez is a visionary business leader with over 20 years of experience in market intelligence and business strategy. As the CEO of The CIO Vision, she has transformed the company from a traditional market research firm into a global leader in business intelligence and strategic insights.\n\nUnder her leadership, The CIO Vision has expanded its global footprint to 15 countries and developed innovative data analytics platforms that serve Fortune 500 clients across industries. Maria is particularly passionate about helping organizations leverage data to drive strategic decision-making and sustainable growth.\n\nPrior to joining The CIO Vision, Maria held executive positions at Global Strategy Partners and Insight Ventures. She began her career as a management consultant at McKinsey & Company, where she advised clients on corporate strategy and organizational transformation.",
    ...
    email: "maria.rodriguez@theciovision.com",
    education: [
      {
        degree: "MBA",
    ...
    quotes: [
      {
        ...
        source: "The CIO Vision Annual Conference, 2024"
      },
      {
  ...
  },
  {
    ...
    company: "The CIO Vision",
    bio: "James Wilson leads the technological innovation at The CIO Vision, overseeing the development of advanced analytics platforms and data intelligence solutions. With a background in computer science and artificial intelligence, James has pioneered the integration of machine learning algorithms into business intelligence applications.\n\nSince joining The CIO Vision in 2018, James has built a world-class engineering team and led the development of the company's flagship InsightIQ platform, which has transformed how clients access and utilize market intelligence. His focus on user experience and practical application of complex technologies has been instrumental in making sophisticated data analysis accessible to business users.\n\nBefore The CIO Vision, James was the founder and CTO of DataVision Analytics, a startup acquired by Google in 2017. He also held senior engineering roles at Microsoft and Amazon, where he worked on cloud computing and machine learning initiatives.",
  ...
  },
  {
    ...
    email: "sarah.johnson@theciovision.com",
    education: [
      {
  ...
  },
  {
    ...
    email: "michael.chen@theciovision.com",
    education: [
      {
        degree: "MBA",
        institution: "INSEAD",
  ...
  },
  {
    ...
    company: "The CIO Vision",
    bio: "Emily Brown oversees human resources and talent development at The CIO Vision, fostering a culture of innovation, inclusion, and continuous learning. With a background in organizational psychology and leadership development, Emily has implemented progressive people practices that have made The CIO Vision a recognized employer of choice in the business intelligence industry.\n\nSince joining the company in 2020, Emily has transformed The CIO Vision's approach to talent management, implementing data-driven recruitment strategies, comprehensive leadership development programs, and innovative performance management systems. Her initiatives have reduced employee turnover by 35% and increased employee engagement scores to industry-leading levels.\n\nBefore joining The CIO Vision, Emily was the Global Head of Leadership Development at LinkedIn and previously held senior HR roles at Deloitte and Google. She is a certified executive coach and speaks regularly at conferences on the future of work, organizational culture, and talent strategy.",
    ...
    email: "emily.brown@theciovision.com",
    education: [
      {
  ...
  },
  {
    ...
    company: "The CIO Vision",
    bio: "David Patel leads financial strategy and operations at The CIO Vision, ensuring the company's sustainable growth and financial health. With expertise in financial planning, investment analysis, and corporate finance, David has played a critical role in scaling the company while maintaining strong profitability and shareholder value.\n\nSince joining The CIO Vision in 2017, David has modernized the company's financial infrastructure, implemented sophisticated forecasting models, and secured strategic funding for global expansion initiatives. His prudent financial management enabled the company to navigate market volatility while continuing to invest in innovation and talent development.\n\nPrior to The CIO Vision, David was the Finance Director at Salesforce and previously held senior finance positions at Oracle and PwC. He began his career in investment banking at Morgan Stanley, specializing in technology and software sectors. David serves on the audit committee of several nonprofit organizations and is a frequent speaker on financial strategy for high-growth companies.",
    ...
    email: "david.patel@theciovision.com",
    education: [
      {
        degree: "MBA, Finance",
...
export const leadershipArticles: LeadershipArticle[] = [
  ...
  },
  {
    ...
    author: "Emily Brown",
    date: "April 5, 2025",
    excerpt: "An exclusive conversation with The CIO Vision's CSO about supply chain resilience and strategic partnerships.",
