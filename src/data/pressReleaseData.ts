...
export const pressReleaseData: PressRelease[] = [
  ...
  {
    id: 2,
    title: "InsightsBW Expands Leadership Advisory Services with Executive Coaching Program",
  ...
  {
    id: 5,
    title: "InsightsBW Appoints Dr. Maya Patel as Chief Research Officer",
  ...
  {
    id: 6,
    title: "InsightsBW Announces Global Expansion with New Offices in Singapore and Dubai",
  ...
  {
    id: 7,
    title: "InsightsBW Foundation Launches $5 Million Initiative to Support Business Education in Underserved Communities",
  ...
  {
    id: 8,
    title: "InsightsBW Releases 2025 Global Business Leaders Survey Results",
